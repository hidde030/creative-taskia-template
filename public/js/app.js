...
if ($(window).width() < 1024) {
  ...
  $('.has-sub').on('click', function (e) {
    ...
    $('ul.navigation').addClass('navigation--hide'); // Add show class on sub navigation

    $(this).find('.navigation__sub').addClass('navigation__sub--active'); // Add show class on navigation go back trigger
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).on('scroll touchmove', function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.header').toggleClass('header--active', jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).scrollTop() > 10);
  }).scroll();
});
